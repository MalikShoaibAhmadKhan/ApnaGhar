  ...
  const features = [
    {
      ...
      title: 'Smart Search',
      description: 'Find your dream home with our advanced AI-powered search and intelligent filtering options.',
      colorKey: 'primary'
    },
    {
      icon: <HomeIcon sx={{ fontSize: 40, color: 'success.main' }} />,
      title: 'Detailed Views',
      description: 'Get comprehensive property information with high-quality photos, virtual tours, and detailed specifications.',
      colorKey: 'success'
    },
    {
      icon: <FavoriteIcon sx={{ fontSize: 40, color: 'error.main' }} />,
      title: 'Personal Wishlist',
      description: 'Create your personalized property wishlist and get instant notifications for similar properties.',
      colorKey: 'error'
    }
  ];
